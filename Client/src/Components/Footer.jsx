  ...
  return (
    ...
    <div className=' py-10'>
      <ul className='flex w-full justify-center text-3xl items-center gap-9' type='none'>
        <li><a href="mailto:vinaykumardag1@gmail.com"><CiMail alt="mail icon"/></a></li>
        <li><a href="https://www.instagram.com/daggupati_vinay/" target='_blank'><FaInstagram alt="mail icon"/></a></li>
